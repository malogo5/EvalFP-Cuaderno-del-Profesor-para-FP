"""EvalFP — Lenguajes de Marcas y Sistemas de Gestión de Información · 0373 · Desarrollo de Aplicaciones Web
...
Duración: 116 h · 3 h/semana · 1º DAW.
"""
MODULO = {
    ...
    "curso":"1º DAW","horas_sem":3,"total_horas":116,"anno":"2026-2027","eval_count":3,
...
UTS = [
    {"id":"UT1","nombre":"Reconocimiento de las características del lenguaje XML","horas":20,"eval":1,"tags":"XML · DTD · XSD · Validación · Namespaces · Parsers SAX/DOM"},
    ...
    {"id":"UT5","nombre":"Aplicación de los lenguajes de marcas en la transmisión de información","horas":18,"eval":2,"tags":"JSON · YAML · RSS · Atom · XSLT · XPath · API REST"},
    {"id":"UT6","nombre":"Gestiona información en formato XML","horas":16,"eval":3,"tags":""},
    {"id":"UT7","nombre":"Opera sistemas empresariales de gestión de información realizando…","horas":20,"eval":3,"tags":""},
]
RAS = [
    ...
    {"id":"RA7","pond":17,"nombre":"Opera sistemas empresariales de gestión de información realizando tareas de importación, integración, aseguramiento y extracción de la información."},
]
ASIGNACIONES = [
...
CES = {
    ...
    "RA2":[{"id":f"CR{i}","texto":t} for i,t in enumerate([
        ...
        "Se han reconocido la funcionalidad de las principales etiquetas y atributos del lenguaje HTML.",
    ...
    "RA3":[{"id":f"CR{i}","texto":t} for i,t in enumerate([
        ...
        "Se han identificado la estructura y la sintaxis de un canal de contenidos.",
