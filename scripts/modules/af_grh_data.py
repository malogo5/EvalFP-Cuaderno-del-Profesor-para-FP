"""EvalFP — Gestión de recursos humanos · 0652 · Administración y Finanzas
...
Duración: 158 h · 4 h/semana · 2º AF.
"""
MODULO = {
    "nombre":"Gestión de recursos humanos","codigo":"0652","abrev":"GRH",
    "ciclo":"Administración y Finanzas","ciclo_clave":"AF","ciclo_nivel":"CFGS",
    "curso":"2º AF","horas_sem":4,"total_horas":158,"anno":"2026-2027","eval_count":2,
...
UTS = [
    {"id":"UT1","nombre":"Contratación laboral","horas":43,"eval":1,"tags":"Modalidades de contrato · Alta y afiliación · Contrat@ · Bonificaciones"},
    {"id":"UT2","nombre":"Modificación, suspensión y extinción del contrato","horas":29,"eval":1,"tags":"Movilidad · Excedencias · Despidos · Liquidación y saldo · Certificado de empresa"},
    {"id":"UT3","nombre":"Obligaciones con la Seguridad Social","horas":38,"eval":2,"tags":"Regímenes · Bases y tipos · RLC y RNT · Sistema RED · Liquidación directa"},
    {"id":"UT4","nombre":"Nómina y retribución","horas":48,"eval":2,"tags":"Estructura de la nómina · IRPF · Cotizaciones · Modelos 111 y 190 · Pagos"},
]
RAS = [
    {"id":"RA1","pond":27,"nombre":"Gestiona la documentación que genera el proceso de contratación, aplicando la normativa vigente."},
    {"id":"RA2","pond":18,"nombre":"Programa las tareas administrativas correspondientes a la modificación, suspensión y extinción del contrato de trabajo, aplicando la normativa vigente y cumplimentando la documentación aparejada."},
    {"id":"RA3","pond":24,"nombre":"Caracteriza las obligaciones administrativas del empresario con la Seguridad Social, tramitando la documentación y realizando los cálculos procedentes."},
    {"id":"RA4","pond":31,"nombre":"Confecciona los documentos derivados del proceso de retribución de recursos humanos y las obligaciones de pagos, aplicando la normativa vigente."},
]
ASIGNACIONES = [
