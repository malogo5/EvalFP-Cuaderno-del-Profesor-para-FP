 ...
 * queda en la ÚLTIMA en la que se trabaja, que es cuando se puede calificar.
 *
 * Antes se quedaba en la primera, y eso colocaba un RA en un trimestre en el que
 * solo se había trabajado uno de sus criterios: la distribución le atribuía todo
 * su peso y la nota de la evaluación salía de una parte mínima del resultado.
 * Un resultado de aprendizaje se califica cuando están trabajados todos sus
 * criterios, así que manda la evaluación de cierre.
 */
